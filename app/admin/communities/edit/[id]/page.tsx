...
export default function EditCommunityPage() {
  ...
  const loadCommunity = async () => {
    try {
      ...
      const community = groups.find((g: any) => g.id === id)
      if (community) {
        setFormData({
          name: community.name,
  ...
  return (
    <AdminLayout>
      <div className="mb-6">
        ...
        <h2 className="text-3xl font-bold text-gray-800 mb-2">Edit Community</h2>
        <p className="text-gray-600">Update community details</p>
      </div>
